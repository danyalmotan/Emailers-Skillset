...
| `partner-footer-white.html` | White footer with offer-valid row, partner lockup, social icons, legal links and unsubscribe copy | Channel / partner mailers that keep Samsung social/legal links but add a partner logo above the footer. Preserve the live Adobe unsubscribe URL in output HTML. |
